...
def getWordScore(word, n):
    ...
    draftScore = 0
    for s in word:
        draftScore +=SCRABBLE_LETTER_VALUES[s]
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    score = 0
    totalScore=0
    while (calculateHandlen(newHand)):
        ...
        if userWord == ".":
            ...
            break
        if (isValidWord(userWord, newHand, wordList)):
            score = getWordScore(userWord, n)
            totalScore +=score
            print ('" {} " earned {} points. total:  {}   points'.format(userWord,score, totalScore))
            print ()
